...
class Rvectors2(Rvectors):
    ...
    def qq_to_RR(self, AA_qq):
        ...
        AA_qq_mp = execute_fft(AA_qq_mp, axes=(0, 1, 2), fftlib=self.fftlib_q2R, destroy=False, inverse=False)/ Nq
        AA_qq_mp = execute_fft(AA_qq_mp, axes=(3, 4, 5), fftlib=self.fftlib_q2R, destroy=False, inverse=True)
